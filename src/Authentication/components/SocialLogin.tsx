...
const Facebook = () => (
    <Svg viewBox="0 0 16 16" width={25} height={25}>
        <Path d="M12 5.5H9v-2a1 1 0 0 1 1-1h1V0H9a3 3 0 0 0-3 3v2.5H4V8h2v8h3V8h2l1-2.5z" fill-rule="evenodd" clip-rule="evenodd" fill="#1976D2"/>
    </Svg>
)
...
const SocialIcon = ({children}: SocialLoginProps) => {
    return (
        <Box marginHorizontal="s" backgroundColor="white" width={SIZE} height={SIZE} borderRadius="l" justifyContent="center" alignItems="center">
            {children}
        </Box>
    )
}
